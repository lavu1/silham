...
@section('page_title', 'Software and Technology')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-9 marginTop-30">
                    <div class="col-12 mt-4">
                        ...
                        <p>
                            The rapid development of technology and its ability to process, transfer and share huge
                            volumes of personal data easily and quickly, has been the major driver for data protection
                            regulations across the globe, Zambia included. The now widespread use of Artificial
                            Intelligence (AI) and automated profiling allows for much greater characterisation and
                            segmentation of individuals and enables better targeting and more informed decision making.
                            This has the potential to adversely affect the rights of individuals whose personal data is
                        ...
                        <p>
                            ...
                            the explicit consent of the data subjects. Mobile Network Operators (MNO’s), Internet
                            Service Providers (ISP’s), Cloud Computing Service providers, software development
                            companies, Fintech companies and other technological services providers, process huge
                            volumes of personal data in their operations. As an organisation in this sector, you ought
                            to be aware of various provisions of the Data Protection Act and other relevant laws
                            regarding the processing of personal data using technology. The Data Protection Act provides
                            for heavy penalties for non-compliance and the organisational reputational damage arising
                            from non-compliance can be irreparable. But more positively, being fully compliant to the
                            provisions of the Act can be leveraged as a competitive advantage and marketed as such to
                            both existing and potential customers alike.
                        </p>
