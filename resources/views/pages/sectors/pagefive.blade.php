            ...
            <div class="row">
                <div class="col-lg-9 marginTop-30">
                    <div class="col-12 mt-4">
                        ...
                        <p>
                            Universities, Colleges, primary and secondary schools, all process huge volumes of personal
                            data of their students and pupils. They are equally obliged under the Data Protection Act,
                            to collect, use, store and transmit personal data in line with the data protection
                            principles of lawfulness, fairness and transparency; purpose limitation; data minimization;
                            accuracy; storage limitation; integrity and confidentiality and accountability. Most
                            educational institutions have deployed various technologies, including software applications
                            and access control systems, to manage their students and pupils’ personal information more
                            efficiently and effectively. This places a huge demand on schools and colleges to comply
                            with the requirements of the Data Protection Act. The consequences for non-compliancy are
                            heavy financial penalties and the reputational damage that would arise from the breach of
                            this law could be irreparable for a school or university. There is therefore no excuse
                            whatsoever. But more positively, being fully compliant to the provisions of the Act can be
                            leveraged as a competitive advantage and marketed as such to both existing and potential
                            customers alike.
                        </p>
                        ...
                        <p>
                            At Silham Consulting and Training Services, we help universities, schools and colleges,
                            navigate the complexity that this new law has introduction in your operations. Silham has
                            assembled a team of consultants that are well vested in the data protection law and relevant
                            technological know-how to help your organisation navigate the complexities of this law. We
                            offer a range of data protection services that are tailored towards helping your
                            organisation overcome obstacles related to data protection. The Data Protection Awareness
