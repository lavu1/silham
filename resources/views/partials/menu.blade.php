    ...
    <div class="container">
        <div class="navbar p-0 navbar-expand-lg">
            <div class="navbar-brand">
                <a class="logo-default" href="#"><img alt="" src="{{ asset('assets/img/logo3.png') }}"></a>
            </div>
          ...
          <div class="hamburger-box">
            ...
            <div class="collapse navbar-collapse when-collapsed" id="ec-nav__collapsible">
                <ul class="nav navbar-nav ec-nav__navbar ml-auto">
                    ...
                    <li class="nav-item nav-item__has-dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Sector</a>
                        <div class="dropdown-menu">
                            <ul class="list-unstyled">
                                ...
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Events & News </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                ...
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Blog </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                ...
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Contact Us </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                ...
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> FAQ's </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                    ...
                    <li class="nav-item nav-item__has-dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> Events & News  </a>
                        <div class="dropdown-menu">
                            <ul class="list-unstyled">
            ...
            <li class="nav-item list-unstyled">
                <a class="nav-link__list px-0" href="#"> FAQ's </a>
            </li>
