            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    ...
                    <div class="margin-y-40">
                        <p>
                            Nunc placerat mi id nisi interdm they mtolis. Praesient is haretra justo ught scel erisque
                            placer.
                        </p>
                    </div>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a class="iconbox bg-white-0_2 hover:primary" href=""><i
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    ...
                    <ul class="list-unstyled marginTop-40">
                        <li class="mb-3"><i class="ti-headphone mr-3"></i><a
                                href="tel:+260750786820">+260 750 78 6820 </a></li>
                        <li class="mb-3"><i class="ti-email mr-3"></i><a href="mailto:info@silhamconsulting.co.zm">info@silhamconsulting.co.zm</a>
                        </li>
                        <li class="mb-3">
                            <div class="media">
...
{{--                </div>--}}
    ...
    <div class="footer-bottom bg-black-0_9 py-5 text-center">
        <div class="container">
            <p class="text-white-0_5 mb-0">&copy; 2024 Silham. All rights reserved. Created by <a href="/">Silham</a>
            </p>
        </div>
